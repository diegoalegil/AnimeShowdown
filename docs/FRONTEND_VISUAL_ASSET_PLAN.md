...
| ID | Archivo | Carpeta | Pagina | Componente | Descripcion | Ratio | Resolucion | Prioridad | Direccion visual |
|---|---|---|---|---|---|---|---|---|---|
| HOME-01 | `home-hero-vote-arena.webp` | `frontend/public/assets/brand/backgrounds/` | Home | `Hero` | Arena anime nocturna con tablero ELO, siluetas de publico y duelos 1v1; sin personajes inventados en primer plano. | 21:9 | 2400x1080 | Alta | Fondo competitivo premium con energia roja/dorada/cian y espacio central limpio para titular. |
| VOTE-01 | `vote-arena.webp` | `frontend/public/assets/brand/backgrounds/` | Votar | `VisualPageShell` | Fondo propio de duelo 1v1, mas directo que torneo generico. | 16:9 | 1920x1080 | Alta | Dos zonas enfrentadas, luz roja y dorada, publico lejano y centro despejado para VS. |
| RANK-01 | `ranking-podium.webp` | `frontend/public/assets/brand/backgrounds/` | Ranking | `CinematicHero` | Podio competitivo con copa, tabla y energia de comunidad. | 21:9 | 2400x1080 | Media | Salon de la fama oscuro con podio, copa central y pantallas de ranking. |
| EMPTY-01 | `catalog-offline.webp` | `frontend/public/assets/error-scenes/` | App | `CatalogoError` | Estado de catalogo caido que no parezca pantalla muerta. | 16:9 | 1600x900 | Alta | Arena cerrada por mantenimiento, luces bajas y panel de roster apagado. |
| EMPTY-02 | `no-duels-open.webp` | `frontend/public/assets/empty-states/` | Votar/Torneos | `EmptyStateScene` | Sin duelos abiertos. | 16:9 | 1600x900 | Media | Bracket vacio esperando combatientes, marcadores apagados y pausa competitiva. |
| GAME-01 | `shadow-guess-character-wall.webp` | `frontend/public/assets/game-covers/` | Shadow Guess | `GamesHubPage` | Portada mas reconocible para silueta/personaje oculto. | 16:9 | 1600x900 | Media | Muro de sombras con silueta central, luz roja lateral y misterio diario. |
| GAME-02 | `anime-reveal-clue-board.webp` | `frontend/public/assets/game-covers/` | Anime Reveal | `GamesHubPage` | Mesa de pistas por anime. | 16:9 | 1600x900 | Media | Tablero de pistas con etiquetas, luces cian/doradas y composicion limpia para titulo. |
...
| Anime | Personaje | Slug sugerido | Prioridad | Motivo | Assets necesarios | Carpeta | Direccion visual |
|---|---|---|---|---|---|---|---|
| One Piece | Usopp | `usopp` | Alta | Completa Straw Hats; falta en roster actual. | SSR, cut, thumb. | `frontend/img/One_Piece/` | Carta 2:3 reconocible, pose heroica con tirachinas, fondo marino y marco premium rojo/dorado. |
| One Piece | Tony Tony Chopper | `tony_tony_chopper` | Alta | Straw Hat esencial y muy votable. | SSR, cut, thumb. | `frontend/img/One_Piece/` | Carta 2:3 expresiva, fondo de barco y nieve suave, recorte limpio para UI. |
| One Piece | Trafalgar Law | `trafalgar_law` | Alta | Rival/favorito muy popular para ranking. | SSR, cut, portrait. | `frontend/img/One_Piece/` | Carta 2:3 con espada, energia azul sutil, fondo oscuro y acentos dorados. |
| One Piece | Donquixote Doflamingo | `donquixote_doflamingo` | Alta | Villano clave para torneos. | SSR, cut, banner opcional. | `frontend/img/One_Piece/` | Carta 2:3 dramatica, abrigo rosa, hilos luminosos y contraste fuerte. |
| One Piece | Kaido | `kaido` | Alta | Top tier para duelos de poder. | SSR, cut. | `frontend/img/One_Piece/` | Carta 2:3 imponente, tormenta de fondo, silueta poderosa y recorte limpio. |
| Bleach | Yhwach | `yhwach` | Alta | Antagonista final; mejora torneos de villanos. | SSR, cut. | `frontend/img/Bleach/` | Carta 2:3 oscura, presencia solemne, acentos frios y borde limpio. |
