...
| `AnimeShowdown-production.postman_environment.json` | Environment con `BASE_URL=https://api.animeshowdown.dev` |
...
4. Arriba a la derecha selecciona el environment activo: **"AnimeShowdown — Local"** o **"AnimeShowdown — Production"**
