      ...
      <div className="flex flex-wrap items-center justify-between gap-3 rounded-xl border border-border bg-surface p-5">
        <div>
          ...
          <p className="text-[12px] text-fg-muted">
            Conteo admin-only de slugs del catálogo frente a assets WebP locales.
          </p>
        </div>
        <button
          type="button"
      ...
      <div className="rounded-xl border border-border bg-surface p-5">
        <div className="flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="text-[12px] text-fg-muted">
              Contador de esta sesión del navegador, agrupado por tipo de fallback.
            </p>
          </div>
          <button
            type="button"
        ...
        <div className="divide-y divide-border">
          {buckets.map((bucket) => (
            ...
            >
              ...
              <span className="font-mono text-fg-muted">{bucket.totalSlots}</span>
              <span className="font-mono text-emerald-300">{bucket.realAssets}</span>
              <span className="font-mono text-amber-200">{bucket.fallbackSlots}</span>
            </div>
          ))}
        </div>
      </div>
