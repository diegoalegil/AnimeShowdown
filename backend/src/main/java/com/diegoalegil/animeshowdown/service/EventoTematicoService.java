...
public class EventoTematicoService {
    ...
    public List<Personaje> seleccionarParticipantes(EventoTematico evento, int tamano) {
        ...
        pool.sort(Comparator
                .comparing((Personaje p) -> rotacion(evento.getSlug(), p.getSlug()))
    ...
    private static int rotacion(String eventoSlug, String personajeSlug) {
        return Math.abs((eventoSlug + ":" + personajeSlug + ":" + LocalDateTime.now(ZoneOffset.UTC).toLocalDate().toString()).hashCode());
    }
